...
public class DemoSupportFocusFragment extends Fragment implements ContentFragment {
    ...
    public void onStart() {
        ...
        BrowseSupportFragment container = (BrowseSupportFragment) getParentFragment();
